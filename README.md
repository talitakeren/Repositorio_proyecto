...
|--------|---------|---------|
| Inicio | [`docs/1.inicio/`](https://github.com/talitakeren/Repositorio_proyecto/tree/main/docs/1.%20inicio) | Definición del problema, visión del proyecto, acta de constitución (Project Charter), identificación del equipo, enfoque de desarrollo, supuestos, restricciones y requerimientos iniciales. |
| Planificación | [`docs/2.planificacion/`](https://github.com/talitakeren/Repositorio_proyecto/tree/main/docs/2.%20planificacion) | Backlog del producto y sprint, cronograma de hitos, presupuesto y gestión de riesgos del proyecto. |
| Ejecución | [`docs/3.ejecucion/`](https://github.com/talitakeren/Repositorio_proyecto/tree/main/docs/3.%20ejecucion) | Documentación técnica del sistema, especificación funcional, casos verificables, evidencias de ejecución, sostenibilidad (Green Software) y evolución de requerimientos. |
| Seguimiento y Control | [`docs/4.seguimiento_control/`](https://github.com/talitakeren/Repositorio_proyecto/tree/main/docs/4.%20seguimiento_control) | Métricas ágiles, validación de requisitos no funcionales, análisis del problema, resultados de pruebas y evidencias de validación. |
...
| Otros | [`docs/6.otros/`](https://github.com/talitakeren/Repositorio_proyecto/tree/main/docs/6.%20otros) | Documentación complementaria del proyecto: AGENTS.md y SPEC.md, utilizados como artefactos de apoyo para la definición técnica y organización del desarrollo. |
